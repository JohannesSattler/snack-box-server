...
// seeds the data from processed data dump to mongo
function createProductSeed() {
    const products = processDataDump()
    Product.insertMany(products)
    console.log('Inserted ' + products.length + ' Items to the Database!')
}

createProductSeed()

// processes the data from raw json
